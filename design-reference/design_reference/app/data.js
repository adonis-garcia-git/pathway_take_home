/* ============================================================
   RFP Pipeline — demo data
   Trattoria Lucia · 214 Court St, Carroll Gardens, Brooklyn NY
   Deliberately messy in places so provenance + confidence + the
   honest empty/needs-review states have real things to express.
   ============================================================ */
window.RFP_DATA = {
  restaurant: {
    ...
    source: "menu page (https://trattorialucia.example/menu)",
    period: "Weekly basket",
  },

  /* ---- Stage 1: Parse Menu → dishes + parsed ingredients ---- */
  dishes: [
  ...
  /* ---- Aggregated weekly ingredient lines ---- */
  ingredients: [
  ...
  /* ---- Stage 2: Pricing (provenance: verified | estimated | nodata) ---- */
  pricing: {
    asOf: "May 28, 2026",
    rows: [
      { id: "ground-beef", price: 4.62, unit: "lb", trend: -3.1, prov: "verified", src: "USDA AMS · LM_XB403" },
      { id: "ground-pork", price: 3.18, unit: "lb", trend: +1.4, prov: "verified", src: "USDA AMS · LM_PK602" },
      ...
      { id: "tomatoes", price: 2.10, unit: "lb", trend: -8.5, prov: "verified", src: "USDA AMS · Terminal Market NY" },
      { id: "basil", price: 12.00, unit: "lb", trend: +0.0, prov: "estimated", src: "Herb category proxy" },
      { id: "soffritto", price: 1.35, unit: "lb", trend: -1.2, prov: "verified", src: "USDA AMS · mixed veg" },
      ...
      { id: "bufala", price: null, unit: "lb", trend: null, prov: "nodata", src: "No public series — import-grade" },
      { id: "mascarpone", price: 7.20, unit: "lb", trend: +0.6, prov: "estimated", src: "Soft cheese proxy" },
      { id: "eggs", price: 3.95, unit: "doz", trend: -12.0, prov: "verified", src: "USDA AMS · Egg Markets" },
      { id: "tagliatelle", price: null, unit: "lb", trend: null, prov: "nodata", src: "Fresh pasta — no commodity series" },
  ...
  /* ---- Stage 3: Distributors (near the address) ---- */
  distributors: [
    { id: "lombardi", name: "Lombardi Specialty Foods", cats: ["dairy", "drygoods", "produce"], dist: "1.2 mi",
      contact: "orders@lombardifoods.example", phone: "(718) 555-0142", prov: "verified", src: "Verified · NY DOH permit #BK-22841",
      blurb: "Full-line Italian importer & distributor. Carroll Gardens since 1971.", lat: 38, lng: 41 },
    { id: "gotham", name: "Gotham Produce Co.", cats: ["produce"], dist: "2.4 mi",
      contact: "sales@gothamproduce.example", phone: "(718) 555-0199", prov: "verified", src: "Verified · Hunts Point vendor",
      blurb: "Daily terminal-market produce, restaurant delivery 6×/week.", lat: 62, lng: 70 },
    { id: "hudson", name: "Hudson Meat Purveyors", cats: ["meat"], dist: "3.1 mi",
      contact: "wholesale@hudsonmeat.example", phone: "(212) 555-0177", prov: "verified", src: "Verified · USDA estab. #8841",
      blurb: "Whole-animal butcher, custom cuts, veal & game.", lat: 26, lng: 64 },
    { id: "costiera", name: "Costiera Imports", cats: ["drygoods", "produce"], dist: "5.8 mi",
      contact: "info@costieraimports.example", phone: "(718) 555-0123", prov: "estimated", src: "Estimated · listing only, unverified",
      blurb: "DOP specialty imports — San Marzano, EVOO, '00 flour.", lat: 74, lng: 22 },
  ],

  /* ---- Stage 4: RFP emails (per distributor send status) ---- */
  emails: {
    ...
    threads: [
      ...
      { id: "hudson",   status: "followed-up", sentAt: "9:02 AM", repliedAt: null, attempts: 2, note: "No reply in 3h — auto follow-up sent 12:05 PM." },
